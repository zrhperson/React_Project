...
describe('Tabs', () => {
  ...
  it('should default works', () => {
    ...
    const tabs = container.querySelectorAll('.bocomui-tabs__tab')
    const panels = container.querySelectorAll('.bocomui-tabs__panel')
  ...
  it('should activeIndex works', () => {
    ...
    expect(findDOMNode(instance).querySelectorAll('.bocomui-tabs__tab')[1].className).toContain('active')
  })
  ...
  it('should onChange works', () => {
    ...
    TestUtils.Simulate.click(findDOMNode(instance).querySelector('.bocomui-tabs__tab > a'))
  ...
  it('should dynamic works', () => {
    ...
    expect(findDOMNode(instance).querySelector('.bocomui-tabs__tab-remove')).not.toBeNull()
  })
  ...
  it('should handleClose works', () => {
    ...
    TestUtils.Simulate.click(findDOMNode(instance).querySelector('.bocomui-tabs__tab-remove'))
    expect(handleClose).toBeCalledWith(0, undefined)
  })
  ...
  it('should controled activeIndex works', () => {
    ...
    const tabNodes = findDOMNode(instance).querySelectorAll('.bocomui-tabs__tab')
    const panelNodes = findDOMNode(instance).querySelectorAll('.bocomui-tabs__panel')

...
class Tab extends Component {
  ...
  render() {
    ...
    return (
      <li className={classNames('bocomui-tabs__tab', {
        'bocomui-tabs__tab--active': isActive
      }, className)} {...other}>
        <a href="" onClick={this.handleClick.bind(this, index)}>
          <span className="bocomui-tabs__tab-content">{children}</span>
          {
            tabs.props.dynamic && !abolishClose && (
              <Button
                ...
                icon="remove"
                size="sm"
                className="bocomui-tabs__tab-remove"

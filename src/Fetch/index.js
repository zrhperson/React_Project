...
class Fetch extends Component {
  ...
  stateMap = {
    ...
    loading() {
      return (
        <div className="bocomui-fetch__mask">
          <Spinner height={this.props.spinnerHeight} className="bocomui-fetch__state" />
        </div>
      )
    },
    error() {
      return (
        <div className="bocomui-fetch__mask">
          <div className="bocomui-fetch__state bocomui-fetch__state-error">{this.state.msg}</div>
        </div>
      )
    }
  }
  ...
  render() {
    ...
    return (
      <div className={classnames('bocomui-fetch', className)} {...other}>

...
class Slider2 extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={classnames('bocomui-slider2', {
          'bocomui-slider2--disabled': disabled
        }, className)}
        onClick={::this.handleClick}
        {...other}
      >
        <div className="bocomui-slider2__layer" ref={node => this.layerNode = node}>
          <div className="bocomui-slider2__range" ref={node => this.rangeNode = node} />
          <Popover
          ...
          >
            <div
              className="bocomui-slider2__slider"

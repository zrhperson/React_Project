...
describe('Tree', () => {
  ...
  it('should data works', () => {
    ...
    expect(findDOMNode(instance).querySelectorAll('.bocomui-tree__node').length).toBe(3)
  })
  ...
  it('should toggle works', () => {
    ...
    TestUtils.Simulate.click(container.querySelector('.bocomui-tree__node-toggle'))
    expect(container.querySelector('.bocomui-tree__node').className).toContain('open')
  })
  ...
  it('should custom render works', () => {
    ...
    expect(findDOMNode(instance).querySelector('.bocomui-tree__node-content').textContent).toBe('a-')
  })
  ...
  it('should getIcon works', () => {
    ...
    expect(findDOMNode(instance).querySelector('.bocomui-tree__node-type').className).toContain('folder')
  })
  ...
  it('should onActive works', () => {
    ...
    TestUtils.Simulate.click(findDOMNode(instance).querySelector('.bocomui-tree__node-content'))
  ...
  it('should onCheck works', () => {
    ...
    TestUtils.Simulate.change(findDOMNode(instance).querySelector('.bocomui-checkbox input'), {
      target: {
        checked: true
      }
    })

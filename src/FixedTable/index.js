      ...
      <tbody>
        {
          ...
          rows.map((item, j) => {
            ...
            <tr>
              <td colSpan={column.length} className="bocomui-fixedtable__empty">
                {noDataContent}
              </td>
            </tr>
          )
...
class FixedTable extends Component {
  ...
  render() {
    ...
    return (
      <div className="bocomui-fixedtable--fixed">
        <div style={{overflowY: 'auto', height: this.props.height + 'px'}}>
          <table className={classnames('bocomui-fixedtable', className)} {...other} >
            <thead>
              <tr>
                {checkboxTh}
                {
                  column.map ((head, i) => {
                    ...
                    if(head['order'] === true) {
                      orderClassName = 'bocomui-datatable--sorting'
                    } else if(head['order'] === 'asc') {
                      orderClassName = 'bocomui-datatable--sorting_asc-default'
                    } else if(head['order'] === 'desc') {
                      orderClassName = 'bocomui-datatable--sorting_desc-default'
                    }
    ...
    if (column.order) {
      ...
      if (orderElAttr == null || !orderElAttr) {
        if(column.order === true) {
          orderEl.className = 'bocomui-datatable--sorting_asc'
          ...
          orderEl.className = 'bocomui-datatable--sorting_desc'
      ...
      if (orderElAttr == 'asc') {
        if(column.order === true) {
          this.refs[i].className = 'bocomui-datatable--sorting_desc'
          ...
          this.refs[i].className = 'bocomui-datatable--sorting_asc-default'
      ...
      if (orderElAttr == 'desc') {
        if(column.order === true) {
          this.refs[i].className = 'bocomui-datatable--sorting_asc'
          ...
          this.refs[i].className = 'bocomui-datatable--sorting_desc-default'
          this.refs[i].setAttribute('order', '')
          this.setState({
            order: '&key=' + column['key']
          })

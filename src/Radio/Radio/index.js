...
const Radio = props => {
  ...
  const classNames = classnames('bocomui-radio', {
    'bocomui-radio--disabled': inputProps.disabled
  }, className)
  ...
  return (
    ...
    >
      ...
      <span className="bocomui-radio__status"></span>
      {children && <span className="bocomui-radio__text">{children}</span>}
    </label>
  )
}

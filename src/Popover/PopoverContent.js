...
class PopoverContent extends Component {
  ...
  setPosition() {
    ...
    this.positionClassNames = classnames({
      [`bocomui-popover--${computedDirection}`]: true,
      [`bocomui-popover--align-${computedAlign}`]: !!computedAlign
    })
  ...
  render() {
    ...
    return (
      <div className={classnames('bocomui-popover', {
        'bocomui-popover--animation': triggerMode === 'hover'
      }, className)} {...other}>
        <div className="bocomui-popover__content">
          {children}
        </div>
      </div>
    )

...
class Slider extends Component {
  ...
  render() {
    ...
    return (
      <div ref="container" className={classnames('bocomui-slider', className)} {...other}>
        <div ref="bar" className="bocomui-slider__bar">
          <div ref="slider" className="bocomui-slider__slider" onMouseDown={::this.handleMouseDown}>
            <div ref="tip" className="bocomui-slider__tooltips">
              <span ref="msg" className="bocomui-slider__tooltips-text">0{this.props.suffix || ''}</span>
              <div className="bocomui-slider__tooltips-arrow-down"></div>
            </div>
          </div>
          <div ref="selectedBar" className="bocomui-slider__bar--selected"></div>
...
class Scale extends Component {
  ...
  render() {
    ...
    for (let i = 0; i <= this.tickValue; i++) {
      rows.push(<div key={i} ref={'t'+i} className="bocomui-scale__tick"><div></div>{i}</div>)
    }

    return (
      <div ref="container" className={classnames('bocomui-scale', this.props.className)}>
        {rows}
      </div>
    )
  }

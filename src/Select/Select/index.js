...
class Select extends Component {
  ...
  render() {
    ...
    const classNames = classnames('bocomui-select', {
      [`bocomui-select--${size}`]: size,
      [`bocomui-select--searchable`]: searchable
    }, className)
    ...
    const Title = (
      <TextOverflow>
        <div className="bocomui-select__title">{title}</div>
      </TextOverflow>
    )
    ...
    return (
      ...
      >
        {searchable && (
          <ClearableInput
            ref="clearableInput"
            className="bocomui-select__search-input"
            value={searchValue}
        ...
        <ul className="bocomui-select__options">
          {optionsWithProps && optionsWithProps.length ? optionsWithProps : (
            <li className="bocomui-select__option">{noOptionsContent}</li>
          )}
        </ul>
      </SelectDropdown>
    )

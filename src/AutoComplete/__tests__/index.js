...
describe('AutoComplete', () => {
  ...
  it('should update works', () => {
    ...
    expect(document.querySelectorAll('.bocomui-auto-complete__result li').length).toBe(1)
  })
  ...
  it('should tab works', () => {
    ...
    expect(document.querySelectorAll('.bocomui-auto-complete__result li')[0].className).toContain('active')
  })
})

...
class FormItem extends Component {
  ...
  render() {
    ...
    const Help = help && (
      <div className="bocomui-form__item-tip">
    ...
    const classNames = classnames('bocomui-form__item', {
      'bocomui-form__item--error': error
    }, className)
    ...
    return (
      <div className={classNames} {...other}>
        {label && (
          <div
            className={classnames('bocomui-form__item-label', {
              'bocomui-form__item-label--required': required
            })}
        ...
        <div className="bocomui-form__item-content">
          {children}
          {Error || Help}
        </div>
      </div>

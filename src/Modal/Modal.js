...
const scrollbarWidth = (() => {
  ...
  scrollDiv.className = 'bocomui-modal--scrollbar-measure'
  ...
  renderIntoDocument() {
    ...
    const onRendered = () => {
      if (!this.toggleModal) {
        ...
        this.toggleModal = new ToggleNode(node, 'bocomui-modal--open')

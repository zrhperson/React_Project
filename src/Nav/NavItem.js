...
class NavItem extends Component {
  ...
  render() {
    ...
    const NavIcon = icon && <Icon type={icon} className="bocomui-nav__item-icon" />
    const Toggle = children && <Icon type="caret-right" className="bocomui-nav__item-toggle" />
    ...
    const classNames = classnames(
      'bocomui-nav__item',
      {
        'bocomui-nav__item--open': open,
        'bocomui-nav__item--active': active
      },
      className
    )

...
class Editable extends Component {
  ...
  render() {
    ...
    return (
      <div className={classnames('bocomui-editable', className)} {...other}>
        {editing ? (
          <div className="bocomui-editable__editing-container">
            <Input
              ref="input"
              value={changedValue}
          ...
          <div
            className="bocomui-editable__normal-container"

...
class Paging extends Component {
  ...
  render() {
    ...
    return (
      <Row>
        <div className="bocomui-paging__layout-div bocomui-paging__total-name">
          {auxiliaryRender(this.props)}
        </div>
        <div className="bocomui-paging__layout-right">
          <ul className="bocomui-paging__pagination">
            <li>
              <a onClick={::this.handleLaquoClick} className={'bocomui-paging__pagination-li--prev '+ (currentIndex === 1 ? 'bocomui-paging__pagination-li--frist' : '')}>&lt;</a>
            </li>
            {this.getPages(currentIndex, pageNum)}
            <li>
              <a onClick={::this.handleRaquoClick} className={'bocomui-paging__pagination-li--next '+ (currentIndex === pageNum ? 'bocomui-paging__pagination-li--end' : '')}>&gt;</a>
            </li>
          </ul>
          {!this.props.hideGo ? (
            <div className="bocomui-paging__go">
              <Input onChange={::this.checkNumber} value={this.state.goPageNum} className="bocomui-paging__go-number"/>
  ...
  createPageEl(num, key) {
    key = key || num
    const active = 'bocomui-paging__pagination-li--active'

...
export default (env, flag) => {
  ...
  env.svg.select('.pie-slices')
    .selectAll('.bocomui-pie-md')
    .on('click', function(d) {
      d3.select('.pie-slices').selectAll('.bocomui-pie-lg').style('display', 'none')
      d3.select('.pie-slices').selectAll('.bocomui-pie-md').style('display', 'block')
      d3.select(env.container).selectAll('.bocomui-pie-flag').style('display', 'none')
  ...
  env.svg.select('.pie-slices')
    .selectAll('.bocomui-pie-md,.bocomui-pie-lg')

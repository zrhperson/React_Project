...
class SelectTable extends Component {
  ...
  render() {
    ...
    return (
      <div style={{height: this.props.height + 'px'}} className="bocomui-transfer__bocomui-table">
        <div className="bocomui-transfer__list-group bocomui-transfer__bocomui-table-conent">
          {rows}
        </div>
      </div>
    )
